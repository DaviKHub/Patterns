...
class StudentsApp < FXMainWindow
  ...
  def initialize(app)
    ...
    # Добавлен обработчик для выбора строки таблицы
  ...
  def update_table
    ...
    if @data.empty?
      FXMessageBox.warning(self, MBOX_OK, "Внимание", "Нет данных для отображения")
      @table.setTableSize(0, 5)
      @page_label.text = "Страница 0 из 0"
      return
    end
  ...
  def update_button_states
    ...
    @delete_button.enabled = selected_rows.size > 0
  end
